...
var listOfCheckFuncs = [
    ...
    function(num) {
        ...
        else if(adj[2] >= 6) return ["Six Conglomerated Pair", "Six pair, all individually adjacent", TODO]
        else if(adj[2] >= 5) return ["Five Conglomerated Pair", "Five pair, all adjacent", TODO]
        else if(adj[2] >= 4) return ["Four Conglomerated Pair", "Four pair, all individually adjacent", TODO]
        else if(adj[2] >= 3) return ["Three Conglomerated Pair", "Three pair, all individually adjacent", TODO]
        else if(adj[2] >= 2) return ["Two Conglomerated Pair", "Two pair, all individually adjacent", TODO]
    },
    function(num) {
